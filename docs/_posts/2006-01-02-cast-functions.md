...
| Integer  | If a integer value is 1, then it is converted to true, otherwise it is converted to false. |
| Float    | If a float value is 1, then it is converted to true, otherwise it is converted to false. |
