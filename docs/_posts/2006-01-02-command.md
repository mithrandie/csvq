...
|  1 | Errors outside the csvq | 
|  2 | I/O errors | 
|  4 | Timeout errors |
|  8 | Syntax errors | 
| 16 | Errors inside the csvq | 
| 32 | The default of triggered errors by [TRIGGER ERROR]({{ '/reference/control-flow.html#trigger_error' | relative_url }}) statements | 
