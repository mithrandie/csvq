...
PARTITION PERCENT PERCENT_RANK PRECEDING PRINT PRINTF PRIOR PWD
RANGE RANK RECURSIVE RELATIVE RELOAD REMOVE RENAME RETURN RIGHT ROLLBACK ROW ROW_NUMBER
